/*
  # Fave Platform - Initial Database Schema
  1. Purpose: Complete database schema for creator-fan royalty tokenization platform
  2. Schema: Users, profiles, distributors, projects, token holdings, transactions, revenue payouts
